...
/**
 * Grundy game. This version 1 optimizes the detection of losing positions by
 * storing identified losing configurations in an array (posPerdantes) to avoid
 * unnecessary recalculations.
 *
 * The losing positions are normalized (piles > 2, sorted) before being added to
 * the list and checked during each call.
 *
...
class GrundyRecPerdantes {
    ...
    /**
     * Indicates if the configuration is known to be losing
     *
     * @param jeu game board
     ...
     *
     * @param jeu the game board
     * @param attendu the expected result of estConnuePerdante
     */
    ...
    /**
     * Normalizes the game board by removing piles with 2 or fewer matches
     *
     * @param jeu game board
    ...
    /**
     * Brief tests for the normaliser() method
     */
    void testNormaliser() {
        System.out.println("*** testNormaliser() ***");

        // Case 1: List containing both valid and invalid piles
        ArrayList<Integer> jeu1 = new ArrayList<>();
        jeu1.add(1);
        jeu1.add(3);
        jeu1.add(5);
        ...
        // Case 2: List containing only valid piles
        ArrayList<Integer> jeu2 = new ArrayList<>();
        jeu2.add(4);
        jeu2.add(6);
        ...
        // Case 3: List containing only invalid piles
    ...
    /**
     * Test a case of the normaliser() method
     *
     * @param jeu the game board
     * @param attendu the expected result of normaliser
     */
